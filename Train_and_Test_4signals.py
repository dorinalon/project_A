...
only_PPG_path = '/home/shirili/Downloads/ShirirliDorin/project_A/out_data_4_sig_6_10/'
...
def calc_loss_precentage(expec_BP, pred_BP, time_length, iteration_num, patient_num,train_start_time):
    ...
    plt.xlabel('mean value for every 0.5 minute ')
    plt.ylabel('mmHg')
    plt.title(" BP Prediction based on PPG, RI, ECG,systolic and diastolic, iteration " + str(iteration_num))
    plt.legend()
    plt.savefig(str(only_PPG_path) + str(patient_num) + '_'+str(train_start_time) + '/Prediction and Expected BP systolic and diastolic ' + str(iteration_num))
...
def Train_and_Test_4signals(path_bp, path_ppg, path_ecg, path_ri,patient_num, train_start_time):
    ...
    # plt.plot(train_ppg_scaled[:1000,0], label='train_ppg')
    # plt.plot(train_ecg_scaled[:1000,0], label='train_ecg')
    # plt.plot(train_ri_scaled[:1000,0], label='train_ri')
    # plt.plot(train_bp_scaled[:1000,0], label='train_BP')
    # plt.legend()
    # plt.show()
    # plt.clf()
    # plt.plot(test_ppg_scaled[:1000,0], label='test_ppg')
    # plt.plot(test_ecg_scaled[:1000,0], label='test_ecg')
    # plt.plot(test_ri_scaled[:1000,0], label='test_ri')
    # plt.plot(test_bp_scaled[:1000,0], label='test_BP')
    # plt.legend()
    # plt.show()
    # Creating lstm class
    ...
    t_inp_ecg = torch.Tensor(test_ecg_scaled.reshape((test_ecg_scaled.shape[0], -1, 1))).cuda()
    t_inp_ri = torch.Tensor(test_ri_scaled.reshape((test_ri_scaled.shape[0], -1, 1))).cuda()
    ...
    for t in range(301):
        ...
        if t%40==0:
            ...
            plt.legend()
            plt.savefig(str(only_PPG_path) + str(patient_num) +'_'+str(train_start_time)+ '/iteration_' + str(t) )
            ...
            plt.xlabel('samples')
            plt.ylabel('mmHg')
            plt.title(" BP Prediction based on PPG, RI, ECG, iteration " + str(t))
            plt.legend()
            plt.savefig(str(only_PPG_path) + str(patient_num) +'_'+str(train_start_time)+ '/Prediction and Expected BP ' + str(t))

            calc_loss_precentage(test_bp_scaled[:,1], pred_t[:,1].data.cpu().numpy(), test_size_125Hz, t, patient_num,train_start_time)
    ...
    plt.ylabel('loss')
    plt.savefig(str(only_PPG_path) + str(patient_num) +'_'+ str(train_start_time)+ '/Mean_loss')
    ...
    # print(str(np.shape(pred_t.data.cpu())))
    # print(str(pred_t[:,1].data.cpu()))
    pred_t = scaler_BP.inverse_transform(pred_t[:,:,0].data.cpu())
    ...
    plt.clf()
    plt.plot(pred_t[:1000,1], label ='prediction_BP')
    plt.plot(test_bp_scaled[:1000,1], label ='expected_BP')
    plt.xlabel('samples')
    plt.ylabel('mmHg')
    plt.title(" BP Prediction based on PPG, RI, ECG")
    plt.legend()
    plt.savefig(str(only_PPG_path) + str(patient_num) +'_' +str(train_start_time) +'/FINAL: Prediction and Expected BP')
    calc_loss_precentage(test_bp_scaled[:, 0], pred_t[:, 0], test_size_125Hz,'orig value ', patient_num,train_start_time)
    #calc_loss_precentage(test_bp_scaled[:, 1], pred_t[:, 1].data.cpu().numpy(), test_size_125Hz, t, patient_num)

    path = str(only_PPG_path) + str(patient_num) +'_'+ str(train_start_time)+'/expec0_pred1.csv'
    i=0
    with open(path,'w') as csv_file:
        csv_reader = csv.writer(csv_file, delimiter=',')
        line_count = 0
        for i in range(test_size_125Hz):
            csv_reader.writerow([test_bp[i, 1], pred_t[i, 1]])

    print("finised "+str(patient_num))
...
Train_and_Test_4signals('/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2642420-8086/2642420-8086_BP_125Hz.csv',
                        ...
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2642420-8086/2642420-8086_ECG_125Hz.csv',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2642420-8086/2642420-8086_RI_125Hz.csv',
                        '2642420-8086',0)
...
Train_and_Test_4signals('/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2728529-6534/2728529-6534_BP_125Hz.csv',
                        ...
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2728529-6534/2728529-6534_ECG_125Hz.csv',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2728529-6534/2728529-6534_RI_125Hz.csv',
                        '2728529-6534',0)
...
Train_and_Test_4signals('/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_BP_125Hz.csv',
                        ...
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_ECG_125Hz.csv',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_RI_125Hz.csv',
                       '2544444-5692',0
                        )
...
Train_and_Test_4signals('/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2210563-9215/2210563-9215_BP_125Hz.csv',
                        ...
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2210563-9215/2210563-9215_ECG_125Hz.csv',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2210563-9215/2210563-9215_RI_125Hz.csv',
                        '2210563-9215',0)
