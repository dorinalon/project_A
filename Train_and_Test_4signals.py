...
only_PPG_path = '/home/shirili/Downloads/ShirirliDorin/project_A/out_data_all_sig/'
...
def Train_and_Test_4signals(path_bp, path_ppg, path_ecg, path_ri,patient_num, test1_bp_path,test1_ppg_path,test1_ecg_path,test1_ri_path):
    ...
    train_bp = data_bp[8000:train_size_125Hz, :]
    train_ppg = data_ppg[8000:train_size_125Hz, :]
    train_ecg = data_ecg[8000:train_size_125Hz, :]
    train_ri = data_ri[8000:train_size_125Hz, :]
    ...
    test_ecg = data_ecg[train_size_125Hz:train_size_125Hz + test_size_125Hz, :]
    test_ri = data_ri[train_size_125Hz:train_size_125Hz + test_size_125Hz, :]
    ...
    scaler_t_BP = MinMaxScaler(feature_range=(-1,1))
    test_bp_scaled = scaler_t_BP.fit_transform(test_bp)

    scaler_t_ECG = MinMaxScaler(feature_range=(-1,1))
    test_ecg_scaled = scaler_t_ECG.fit_transform(test_ecg)

    scaler_t_RI = MinMaxScaler(feature_range=(-1,1))
    test_ri_scaled = scaler_t_RI.fit_transform(test_ri)

    scaler_t_PPG = MinMaxScaler(feature_range=(-1,1))
    test_ppg_scaled = scaler_t_PPG.fit_transform(test_ppg)
    ...
    for t in range(2):
        ...
        if t%50==0:
            ...
            plt.legend()
            plt.savefig(only_PPG_path + patient_num + '/Prediction and Expected BP ' + str(t))
    ...
    # scaler_BP.inverse_transform(test_bp.data.cpu().numpy())
    # TODO: inverse the pred and test back to original
...
Train_and_Test_4signals('/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_BP_125Hz.csv',
                       ...
                       '2544444-5692',
                       '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2210563-9215/2210563-9215_BP_125Hz.csv',
...
Train_and_Test_4signals('/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2210563-9215/2210563-9215_BP_125Hz.csv',
                        ...
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2210563-9215/2210563-9215_RI_125Hz.csv',
                        '2210563-9215',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_BP_125Hz.csv',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_PPG_125Hz.csv',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_ECG_125Hz.csv',
                        '/home/shirili/Downloads/ShirirliDorin/project_A/data_4_sig/2544444-5692/2544444-5692_RI_125Hz.csv')
